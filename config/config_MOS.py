def get_config():
    class General:
        ...
        SeqDir = "/home/ssd_data/ROOT_KITTI/KITTI/dataset/sequences"
    ...
    class DatasetParam:
        class Train:
            ...
            class CopyPasteAug:
                is_use = True
                ObjBackDir = "/home/ssd_data/ROOT_KITTI/object_bank_semkitti"
    ...
    class ModelParam:
        ...
        class pretrain:
            pretrain_epoch = 8  # 이 숫자까지 학습했다고 가정함. 즉 +1 한 Epoch을 이어서 시작할 것임.
